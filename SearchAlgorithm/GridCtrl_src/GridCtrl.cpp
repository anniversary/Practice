...
void CGridCtrl::OnDraw(CDC* pDC)
{
    ...
    if (m_nGridLines == GVL_BOTH || m_nGridLines == GVL_HORZ)
    {
		...
		//pDC->MoveTo(nFixedColWidth, y+2);
        //pDC->LineTo(VisRect.right,  y+2);
...
//////////////////////////////////////////////////////////////////////////
// XRadish + [4/9/2003] 
BOOL CGridCtrl::CreateFromStatic(UINT nID , //the static control resource ID
								 CWnd * pParent )
{
	CStatic wndStatic;
	...
	return Create( rc, pParent, nID, WS_CHILD | WS_VISIBLE  );
}
